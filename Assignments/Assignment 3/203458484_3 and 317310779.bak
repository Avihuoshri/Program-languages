...
;;it wasn't difficult for me to implement the sqrt part
...
;;this function was preatty difficult to me to understand so I ask my friends for explenation
;;for the With case and after a few explenations I can say that its cler for me
...
;; this function implementation was preatty hard to understand and it took somthing like 1 day to implement
...
;; I used one of the TA for the implementation part
;; in this part I was asked to check if there are free instances and return a list of them (if there were any)
...
;;For this function I used "containsFreeInstance" function that we lerned in TA presentation #6
